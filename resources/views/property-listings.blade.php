                    ...
                    <div id="archive-wrapper">
                        ...
                        <div class="row-fluid">
                            <div class="row-fluid property-listing status-35 clearfix">
                                ...
                                <div class="listing-info span7">
                                    <div class="listing-title">
                                        <a href="{{route('property-single')}}" title="Florida 5, Pinecrest, FL">Florida 5, Pinecrest, FL</a>
                            ...
                            <div class="row-fluid property-listing status-35 clearfix">
                                <div class="listing-image span5">
                                    <div class="property-image-container">
                                        <a href="{{route('property-single')}}" title="1200 Anastasia Avenue, Coral Gables">
                                ...
                                <div class="listing-info span7">
                                    <div class="listing-title">
                                        <a href="{{route('property-single')}}" title="1200 Anastasia Avenue, Coral Gables">1200 Anastasia Avenue, Coral Gables</a>
                                        <i class="icon-heart"></i>
                                    </div>
                                    <div class="listing-content">
                                        <div class="listing-property-price">
                            ...
                            <div class="row-fluid property-listing status-28 clearfix">
                                <div class="listing-image span5">
                                    <div class="property-image-container">
                                        <a href="{{route('property-single')}}" title="60 Merrick Way, Miami">
                            ...
                            <div class="row-fluid property-listing status-28 clearfix">
                                <div class="listing-image span5">
                                    <div class="property-image-container">
                                        <a href="{{route('property-single')}}" title="15421 Southwest 39th Terrace">
                                ...
                                <div class="listing-info span7">
                                    <div class="listing-title">
                                        <a href="{{route('property-single')}}" title="15421 Southwest 39th Terrace">15421 Southwest 39th Terrace</a>
                                        <i class="icon-heart"></i>
                                    </div>
                                    <div class="listing-content">
                                        <div class="listing-property-price">
                            ...
                            <div class="row-fluid property-listing status-35 clearfix">
                                <div class="listing-image span5">
                                    <div class="property-image-container">
                                        <a href="{{route('property-single')}}" title="700 Front Street, Key West, FL"><img width="540" height="360" src="uploads/dummy-540x360.png" class="attachment-real-property-loop wp-post-image" alt="700 Front Street, Key West, FL" title="700 Front Street, Key West, FL" /></a>
                                    </div><!-- /.property-images-container -->
                                    <div class="listing-meta">
                                        <ul>
                                            <li class="meta-size"><i class="ico-size"></i>200M</li>
                                ...
                                <div class="listing-info span7">
                                    <div class="listing-title">
                                        <a href="{{route('property-single')}}" title="700 Front Street, Key West, FL">700 Front Street, Key West, FL</a>
                                        <i class="icon-heart"></i>
                                    </div>
                                    <div class="listing-content">
                                        <div class="listing-property-price">
